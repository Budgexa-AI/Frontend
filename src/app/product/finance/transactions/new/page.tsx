...
export default function AddTransactionPage() {
  ...
  async function onSubmit(data: AddTransactionFormValues) {
    ...
    const result = await createTransactionAction({
      ...
      category: data.category as AddTransactionFormValues["category"],
    ...
    // On success, createTransactionAction redirects — nothing else needed.
  }
          ...
          {PAYMENT_METHODS.map((m) => (
            <button
              ...
              onClick={() =>
                setValue(
                  "paymentMethod",
                  paymentMethod === m.value ? undefined : m.value,
