...
export const metadata: Metadata = {
  title: "About – Rayo AI",
  description:
    "Rayo AI is an AI-powered financial assistant that helps people understand spending, build smarter habits, and make better financial decisions.",
};

export default function AboutPage() {
  return (
    <main className="min-h-screen bg-rayo-beige text-rayo-text overflow-hidden">
      ...
      <section className="animate-fade-up-1 text-center pt-32 pb-24 px-6 max-w-[760px] mx-auto">
        ...
        <p className="text-[17px] text-rayo-text-muted leading-[1.65] mx-auto">
          Rayo AI helps you understand your money with intelligent insights, spending analysis, and personalized financial guidance. We&apos;re making financial management simpler, more proactive, and easier to build habits around.
        </p>
      </section>
      ...
      <section className="animate-fade-up-3 py-12 px-6 pb-28 max-w-[820px] mx-auto">
        <div className="relative overflow-hidden bg-rayo-green rounded-3xl px-10 py-16 text-center">
          ...
          <p className="text-[15px] text-rayo-beige/70 leading-[1.7] max-w-[400px] mx-auto mb-8">
            Your financial data should stay private and secure. Rayo uses modern security practices and encrypted connections to help protect your information at every step.
          </p>
