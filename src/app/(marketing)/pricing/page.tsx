...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen">
      {/* ── 1. HERO SECTION (100vh Split Dark Green / Cream) ── */}
      <section className="relative overflow-hidden min-h-[calc(100dvh-4rem)] pt-16 flex flex-col">
        <div className="grid grid-cols-1 lg:grid-cols-12 flex-1 h-full overflow-hidden">
          
          {/* Left Column: Dark Green background with Heading & Trust */}
          ...
          {/* Right Column: Cream Background with Laptop Display */}
