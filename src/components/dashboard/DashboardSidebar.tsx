...
const NAV = [
  ...
  // { label: "Reports", href: "/product/reports", icon: BarChart3 },
];
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="border-t border-border p-4">
        <button className="flex w-full items-center gap-3 rounded-2xl p-3 hover:bg-card">
          {profile?.avatarUrl ? (
            <Image
...
function getNavDescription(label: string) {
  switch (label) {
    case "Dashboard":
      return "Your financial progress at a glance";

    case "Transactions":
      return "Track every money movement";

    case "Budget":
      return "Plan and control your spending";

    case "Goals":
      return "Build toward financial milestones";

    case "Insights":
      return "AI guidance to improve decisions";

    case "Reports":
      return "Understand your financial patterns";
